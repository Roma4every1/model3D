...
//       currentMaxX: 1000, currentMaxY: 30,
...
//   }
//
//   public render(linesData: ProfilePlastData, inclData: ProfileInclDataMap): void {
//     this.drawLines(linesData);
//     this.drawTraceNodes(inclData);
//     this.drawLitology(linesData, inclData)
//     this.drawAxes();
//   }
//
//   private drawLines(linesData: ProfilePlastData): void {
//     linesData.forEach((data, plastCode) => this.drawPlastLines(data));
//   }
//
...
//
//       if (isFirstPoint) {
//         this.ctx.moveTo(this.viewport.startX , canvasY);
//         isFirstPoint = false;
//       } else {
...
//     const canvasY = this.viewport.startY + this.viewport.height;
//     this.drawAxisRect(
//       0,
//       canvasY,
//       this.ctx.canvas.width,
...
//   }
//
//   public drawLitology(linesData: ProfilePlastData, inclData: ProfileInclDataMap) {
//
//   }
// }
