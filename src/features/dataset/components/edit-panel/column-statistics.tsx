...
import { setWindowInfo, setWindowWarning, showNotice } from 'entities/windows';
...
export const ColumnStatistics = ({formRef, t}) => {
  ...
  const getStat = async () => {
    ...
    const { ok, data } = await channelsAPI.getStatistics(tableID, cell.column);
    ...
    dispatch(setWindowInfo(info, null, title));
  };
