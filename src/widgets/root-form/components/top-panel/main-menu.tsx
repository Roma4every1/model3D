...
import { configSelector } from '../../../../app/store/app-state/app.selectors';
import { sessionManager } from '../../../../app/store';
import { setOpenedWindow } from 'entities/windows';
import { leftLayoutSelector } from '../../store/root-form.selectors';
import { setLeftTabHeight } from '../../store/root-form.actions';
