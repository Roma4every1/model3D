 ...
 * */
type ParamTableCell = FormParamProto<'tableCell', ParamValueTableCell> & TableParamsAttrs;
 ...
 * */
type ParamTableRow = FormParamProto<'tableRow', ParamValueTableRow> & TableParamsAttrs;
...
interface FormParamProto<Type extends ParameterType, Value> {
  ...
  value: Value,
  formID?: FormID,
  dependsOn?: ParameterDepends | null,
  canBeNull?: boolean,
  displayName?: string,
